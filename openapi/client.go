...
// APIClient manages communication with the Bitbucket Data Center API v9.6
...
type APIClient struct {
	...
	SAMLCertificateConfigurationAPI *SAMLCertificateConfigurationAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.BuildsAndDeploymentsAPI = (*BuildsAndDeploymentsAPIService)(&c.common)
	...
	c.JiraIntegrationAPI = (*JiraIntegrationAPIService)(&c.common)
	c.MarkupAPI = (*MarkupAPIService)(&c.common)
	c.MirroringMirrorAPI = (*MirroringMirrorAPIService)(&c.common)
	c.MirroringUpstreamAPI = (*MirroringUpstreamAPIService)(&c.common)
	...
	c.SAMLCertificateConfigurationAPI = (*SAMLCertificateConfigurationAPIService)(&c.common)
	c.SearchAPI = (*SearchAPIService)(&c.common)
	c.SecurityAPI = (*SecurityAPIService)(&c.common)
	c.SystemMaintenanceAPI = (*SystemMaintenanceAPIService)(&c.common)
...
func (c *APIClient) prepareRequest(
	...
	if strings.HasPrefix(headerParams["Content-Type"], "multipart/form-data") && len(formParams) > 0 || (len(formFiles) > 0) {
		if body != nil {
			return nil, errors.New("сannot specify postBody and multipart form at the same time")
		}
		body = &bytes.Buffer{}
	...
	if strings.HasPrefix(headerParams["Content-Type"], "application/x-www-form-urlencoded") && len(formParams) > 0 {
		if body != nil {
			return nil, errors.New("сannot specify postBody and x-www-form-urlencoded form at the same time")
		}
		body = &bytes.Buffer{}
