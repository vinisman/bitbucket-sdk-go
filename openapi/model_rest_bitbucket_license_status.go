...
// checks if the RestBitbucketLicenseStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestBitbucketLicenseStatus{}
...
// NewRestBitbucketLicenseStatus instantiates a new RestBitbucketLicenseStatus object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRestBitbucketLicenseStatus() *RestBitbucketLicenseStatus {
	this := RestBitbucketLicenseStatus{}
	return &this
}

// NewRestBitbucketLicenseStatusWithDefaults instantiates a new RestBitbucketLicenseStatus object
...
type NullableRestBitbucketLicenseStatus struct {
	value *RestBitbucketLicenseStatus
	isSet bool
}

func (v NullableRestBitbucketLicenseStatus) Get() *RestBitbucketLicenseStatus {
	return v.value
}

func (v *NullableRestBitbucketLicenseStatus) Set(val *RestBitbucketLicenseStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRestBitbucketLicenseStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRestBitbucketLicenseStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestBitbucketLicenseStatus(val *RestBitbucketLicenseStatus) *NullableRestBitbucketLicenseStatus {
	return &NullableRestBitbucketLicenseStatus{value: val, isSet: true}
}
