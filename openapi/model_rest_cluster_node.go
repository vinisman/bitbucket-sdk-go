...
// checks if the RestClusterNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestClusterNode{}
...
// NewRestClusterNode instantiates a new RestClusterNode object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRestClusterNode() *RestClusterNode {
	this := RestClusterNode{}
	return &this
}

// NewRestClusterNodeWithDefaults instantiates a new RestClusterNode object
...
type NullableRestClusterNode struct {
	value *RestClusterNode
	isSet bool
}

func (v NullableRestClusterNode) Get() *RestClusterNode {
	return v.value
}

func (v *NullableRestClusterNode) Set(val *RestClusterNode) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRestClusterNode(val *RestClusterNode) *NullableRestClusterNode {
	return &NullableRestClusterNode{value: val, isSet: true}
}
