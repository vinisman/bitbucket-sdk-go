...
// checks if the RestCommit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestCommit{}
...
// NewRestCommit instantiates a new RestCommit object
...
// NewRestCommitWithDefaults instantiates a new RestCommit object
...
func (o *RestCommit) GetAuthor() RestChangesetToCommitAuthor {
...
func (o *RestCommit) GetAuthorOk() (*RestChangesetToCommitAuthor, bool) {
	if o == nil || IsNil(o.Author) {
		return nil, false
	}
...
func (o *RestCommit) SetAuthor(v RestChangesetToCommitAuthor) {
	o.Author = &v
}
...
func (o *RestCommit) GetCommitter() RestChangesetToCommitAuthor {
...
// and a boolean to check if the value has been set.
func (o *RestCommit) GetCommitterOk() (*RestChangesetToCommitAuthor, bool) {
	if o == nil || IsNil(o.Committer) {
		return nil, false
	}
...
func (o *RestCommit) SetCommitter(v RestChangesetToCommitAuthor) {
	o.Committer = &v
}
...
func NewNullableRestCommit(val *RestCommit) *NullableRestCommit {
	return &NullableRestCommit{value: val, isSet: true}
}
