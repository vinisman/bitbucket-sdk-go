...
// checks if the RestHookScript type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestHookScript{}
...
// NewRestHookScript instantiates a new RestHookScript object
...
// NewRestHookScriptWithDefaults instantiates a new RestHookScript object
...
type NullableRestHookScript struct {
	value *RestHookScript
	isSet bool
}

func (v NullableRestHookScript) Get() *RestHookScript {
	return v.value
}

func (v *NullableRestHookScript) Set(val *RestHookScript) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRestHookScript(val *RestHookScript) *NullableRestHookScript {
	return &NullableRestHookScript{value: val, isSet: true}
}
