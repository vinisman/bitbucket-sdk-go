...
// checks if the RestLabelable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestLabelable{}
...
// NewRestLabelable instantiates a new RestLabelable object
...
// NewRestLabelableWithDefaults instantiates a new RestLabelable object
...
func (o *RestLabelable) GetLabelableType() string {
	if o == nil || IsNil(o.LabelableType) {
		var ret string
		return ret
	}
	return *o.LabelableType
}

// GetLabelableTypeOk returns a tuple with the LabelableType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RestLabelable) GetLabelableTypeOk() (*string, bool) {
	if o == nil || IsNil(o.LabelableType) {
		return nil, false
	}
	return o.LabelableType, true
}
...
func (o *RestLabelable) GetOrigin() RestChangesetRepositoryOrigin {
...
// and a boolean to check if the value has been set.
func (o *RestLabelable) GetOriginOk() (*RestChangesetRepositoryOrigin, bool) {
	if o == nil || IsNil(o.Origin) {
		return nil, false
	}
...
func (o *RestLabelable) SetOrigin(v RestChangesetRepositoryOrigin) {
	o.Origin = &v
}
...
func (o *RestLabelable) GetProject() RestChangesetRepositoryOriginProject {
...
// and a boolean to check if the value has been set.
func (o *RestLabelable) GetProjectOk() (*RestChangesetRepositoryOriginProject, bool) {
	if o == nil || IsNil(o.Project) {
		return nil, false
	}
...
func (o *RestLabelable) SetProject(v RestChangesetRepositoryOriginProject) {
	o.Project = &v
}
...
func (o RestLabelable) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LabelableType) {
		toSerialize["labelableType"] = o.LabelableType
	}
	if !IsNil(o.Links) {
...
func (v NullableRestLabelable) Get() *RestLabelable {
	return v.value
}
...
func NewNullableRestLabelable(val *RestLabelable) *NullableRestLabelable {
	return &NullableRestLabelable{value: val, isSet: true}
}
