...
// checks if the RestMinimalCommit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestMinimalCommit{}
...
// NewRestMinimalCommit instantiates a new RestMinimalCommit object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRestMinimalCommit() *RestMinimalCommit {
	this := RestMinimalCommit{}
	return &this
}

// NewRestMinimalCommitWithDefaults instantiates a new RestMinimalCommit object
...
type NullableRestMinimalCommit struct {
	value *RestMinimalCommit
	isSet bool
}

func (v NullableRestMinimalCommit) Get() *RestMinimalCommit {
	return v.value
}

func (v *NullableRestMinimalCommit) Set(val *RestMinimalCommit) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRestMinimalCommit(val *RestMinimalCommit) *NullableRestMinimalCommit {
	return &NullableRestMinimalCommit{value: val, isSet: true}
}
