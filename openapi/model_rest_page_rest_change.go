...
// checks if the RestPageRestChange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestPageRestChange{}
...
// NewRestPageRestChange instantiates a new RestPageRestChange object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRestPageRestChange() *RestPageRestChange {
	this := RestPageRestChange{}
	return &this
}

// NewRestPageRestChangeWithDefaults instantiates a new RestPageRestChange object
...
type NullableRestPageRestChange struct {
	value *RestPageRestChange
	isSet bool
}

func (v NullableRestPageRestChange) Get() *RestPageRestChange {
	return v.value
}

func (v *NullableRestPageRestChange) Set(val *RestPageRestChange) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRestPageRestChange(val *RestPageRestChange) *NullableRestPageRestChange {
	return &NullableRestPageRestChange{value: val, isSet: true}
}
