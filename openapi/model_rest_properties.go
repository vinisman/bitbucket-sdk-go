...
// checks if the RestProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestProperties{}
...
// NewRestProperties instantiates a new RestProperties object
...
// NewRestPropertiesWithDefaults instantiates a new RestProperties object
...
func (v NullableRestProperties) Get() *RestProperties {
	return v.value
}

func (v *NullableRestProperties) Set(val *RestProperties) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRestProperties(val *RestProperties) *NullableRestProperties {
	return &NullableRestProperties{value: val, isSet: true}
}
