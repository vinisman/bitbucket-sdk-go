...
// checks if the RestPullRequestMergeConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestPullRequestMergeConfig{}
...
// NewRestPullRequestMergeConfig instantiates a new RestPullRequestMergeConfig object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRestPullRequestMergeConfig() *RestPullRequestMergeConfig {
	this := RestPullRequestMergeConfig{}
	return &this
}

// NewRestPullRequestMergeConfigWithDefaults instantiates a new RestPullRequestMergeConfig object
...
func (o *RestPullRequestMergeConfig) GetCommitMessageTemplate() RestPullRequestMergeConfigCommitMessageTemplate {
...
func (o *RestPullRequestMergeConfig) GetCommitMessageTemplateOk() (*RestPullRequestMergeConfigCommitMessageTemplate, bool) {
	if o == nil || IsNil(o.CommitMessageTemplate) {
		return nil, false
	}
...
func (o *RestPullRequestMergeConfig) SetCommitMessageTemplate(v RestPullRequestMergeConfigCommitMessageTemplate) {
...
func (o *RestPullRequestMergeConfig) GetDefaultStrategy() RestPullRequestMergeConfigDefaultStrategy {
...
// and a boolean to check if the value has been set.
func (o *RestPullRequestMergeConfig) GetDefaultStrategyOk() (*RestPullRequestMergeConfigDefaultStrategy, bool) {
	if o == nil || IsNil(o.DefaultStrategy) {
		return nil, false
	}
...
func (o *RestPullRequestMergeConfig) SetDefaultStrategy(v RestPullRequestMergeConfigDefaultStrategy) {
	o.DefaultStrategy = &v
}

// GetStrategies returns the Strategies field value if set, zero value otherwise.
func (o *RestPullRequestMergeConfig) GetStrategies() []RestPullRequestMergeStrategy {
...
// and a boolean to check if the value has been set.
func (o *RestPullRequestMergeConfig) GetStrategiesOk() ([]RestPullRequestMergeStrategy, bool) {
	if o == nil || IsNil(o.Strategies) {
		return nil, false
	}
...
func (o *RestPullRequestMergeConfig) SetStrategies(v []RestPullRequestMergeStrategy) {
	o.Strategies = v
}
...
type NullableRestPullRequestMergeConfig struct {
	value *RestPullRequestMergeConfig
	isSet bool
}

func (v NullableRestPullRequestMergeConfig) Get() *RestPullRequestMergeConfig {
	return v.value
}

func (v *NullableRestPullRequestMergeConfig) Set(val *RestPullRequestMergeConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRestPullRequestMergeConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRestPullRequestMergeConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestPullRequestMergeConfig(val *RestPullRequestMergeConfig) *NullableRestPullRequestMergeConfig {
	return &NullableRestPullRequestMergeConfig{value: val, isSet: true}
}
